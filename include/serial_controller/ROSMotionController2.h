...
#ifndef ROSMOTIONCONTROLLER2_H
#define	ROSMOTIONCONTROLLER2_H
...
class ROSMotionController2 : public AbstractROSController {
public:
    ROSMotionController2(std::string name_node, const ros::NodeHandle& nh, ParserPacket* serial, ServiceSerial* service_serial);
    virtual ~ROSMotionController2();
